...
:set apbSrc ($apbSrc . "all address-list add list=\$List address=\$V timeout=520w comment=\"apb\" ; :set Added (\$Added + 1) } on-error={} } } else={ :if ([:len [/ip firewall address-list find l")
:set apbSrc ($apbSrc . "ist=\$List address=\$V]] = 0) do={ :do { /ip firewall address-list add list=\$List address=\$V timeout=520w comment=\"apb\" ; :set Added (\$Added + 1) } on-error={} } } }")
:set apbSrc ($apbSrc . "\r\n")
...
:set apbSrc ($apbSrc . "st=\$State address=192.0.2.1 comment=(\"\" . \$apbCursor) timeout=520w } on-error={ :log warning (\"APB: could not record cursor \" . \$apbCursor . \" in \" . \$State . ")
...
:set apbSrc ($apbSrc . ":if (\$K = \"+\") do={ :if ([:typeof [:find \$V \":\"]] = \"num\") do={ :do { /ipv6 firewall address-list add list=\$List address=\$V timeout=520w comment=\"apb\" ; :set ")
:set apbSrc ($apbSrc . "Total (\$Total + 1) } on-error={} } else={ :do { /ip firewall address-list add list=\$List address=\$V timeout=520w comment=\"apb\" ; :set Total (\$Total + 1) } on-error=")
...
:set apbSrc ($apbSrc . "0.2.1 comment=(\"\" . \$apbCursor) timeout=520w } on-error={ :log warning (\"APB: could not record cursor \" . \$apbCursor . \" in \" . \$State . \" - the router refused ")
:set apbSrc ($apbSrc . "the address-list write\") } }\r\n:log info (\"APB: rebuild complete, \" . \$Total . \" addresses, cursor now \" . \$apbCursor)\r\n}\r\n")
...
:set apbSrc ($apbSrc . ":do { /ip firewall address-list remove [find list=\$State] } on-error={}\r\n")
:set apbSrc ($apbSrc . ":do { /ip firewall address-list add list=\$State address=1.2.3.4 timeout=520w comment=\"probe\" ; :log info \"APB test: write P, exactly what the real scripts do: OK\" } ")
:set apbSrc ($apbSrc . "on-error={ :log error \"APB test: write P, exactly what the real scripts do: REFUSED\" }\r\n:do { /ip firewall address-list remove [find list=\$State] } on-error={}\r\n")
